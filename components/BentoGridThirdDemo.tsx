    ...
    return (
        ...
        >
            ...
            >
                ...
                <Link href={"https://www.instagram.com/h4rsharma/"} className="border border-red-500 bg-red-100 dark:bg-red-900/20 text-red-600 text-xs rounded-full px-2 py-0.5 mt-4 cursor-pointer">
                    Click
                </Link>
            </motion.div>
...
// Define your items with type annotations
const items = [
    {
        title: "Web Development Services",
        description: (
            <span className="text-sm">
                Experienced in Front-End/Fullstack Development.
            </span>
        ),
        header: <SkeletonOne />,
    ...
    },
    {
        ...
        description: (
            <span className="text-sm">
                ...
                Let's collaborate to unlock your digital potential and achieve unparalleled success.
            </span>
        ),
    ...
    },
    {
        ...
        description: (
            <span className="text-sm">
                We provide unlimited revisions and 24/7 support for clients.
            </span>
        ),
        header: <SkeletonFive />,
        className: "md:col-span-1",
